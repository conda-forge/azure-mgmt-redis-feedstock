...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-mgmt-redis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11014&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-mgmt-redis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-redis` can be installed with:

```
conda install azure-mgmt-redis
```

It is possible to list all of the versions of `azure-mgmt-redis` available on your platform with:
